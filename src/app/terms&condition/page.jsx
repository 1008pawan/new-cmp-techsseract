    ...
    <div>
      <section>
        <div
          ...
          style={{
            backgroundImage: `url("images/TermsOfService.jpg")`,
          }}
        >
      ...
      <section className="p-10 text-zinc-500">
        <h1 className="text-xl font-semibold py-5 text-zinc-600">OVERVIEW</h1>
        <p>
          This website is operated by CMP CookMyProject LLP. Throughout the
          site, the terms “we”, “us” and “our” refer to CMP CookMyProject LLP.
          CMP CookMyProject LLP offers this website, including all information,
        ...
        <h1 className="text-xl font-semibold py-5 text-zinc-600">
        ...
        <p>
          ...
          non-infringement. In no case shall CMP CookMyProject LLP, our
        ...
        <p>
          You agree to indemnify, defend and hold harmless CMP CookMyProject LLP
        ...
        <p>
          ...
          laws of India and jurisdiction of Allahabad, Uttar Pradesh
        </p>
        <h1 className="text-xl font-semibold py-5 text-zinc-600">
